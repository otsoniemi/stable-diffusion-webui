...
- Attention, specify parts of the text that the model should pay more attention to
...
- Extras tab with:
    - GFPGAN, a neural network that fixes faces
    - CodeFormer, a face restoration tool as an alternative to GFPGAN
...
- Generation parameters
     ...
     - drag and drop an image/text-parameters to the prompt box
...
- Seed resizing, a way to generate the same image but at a slightly different resolution
...
6. Run `webui-user.bat` from Windows Explorer as a normal, non-administrator, user.
